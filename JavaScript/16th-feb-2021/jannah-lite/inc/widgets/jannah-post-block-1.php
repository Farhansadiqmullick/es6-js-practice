...
add_action('widgets_init', 'jannah_post_block_1');
function jannah_post_block_1() {
    register_widget('jannah_post_block_1');
}

class jannah_post_block_1 extends WP_Widget{

    public function __construct(){
        parent::__construct('jannah_post_block_1',esc_html__('Jannah Post Block 1','jannah-lite'),array(
            'description' => __('Post block style 1','jannah-lite'),
        ));
    ...
    public function widget($arg,$instance){
        ...
        $before_posts  = '<div class="posts-block-1-items widget-posts-wrapper">';
        $after_posts   = '</div>';
        ...
        if ( ! empty( $bg_color ) || ! empty( $font_color ) ){
            ...
            if ( ! empty( $font_color ) ){
                $out .= "
                    ...
                    $widget_id .posts-block-1-items .post .post-title a:hover,
                    $widget_id .posts-block-1-items .post:first-child a.post-meta:hover {
                        color: $font_color;
                    }
            ...
            if( !empty( $bg_color ) ) {
                $out .= "
                    ...
                    $widget_id .posts-block-1-items .post .post-date,
                    $widget_id .posts-block-1-items .post .post-title{
                        color: white;
                    }
                ";
            }
