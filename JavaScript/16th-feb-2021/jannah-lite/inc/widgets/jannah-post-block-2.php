...
add_action('widgets_init', 'jannah_post_block_2');
function jannah_post_block_2() {
    register_widget('jannah_post_block_2');
}

class jannah_post_block_2 extends WP_Widget{

    public function __construct(){
        parent::__construct('jannah_post_block_2',esc_html__('Jannah Post Block 2','jannah-lite'),array(
            'description' => __('Post block style 2','jannah-lite'),
        ));
    ...
    public function widget($arg,$instance){
        ...
        $before_posts  = '<div class="posts-block-2-items widget-posts-wrapper">';
        $after_posts   = '</div>';
        ...
        if ( ! empty( $bg_color ) || ! empty( $font_color ) ){
            ...
            if ( ! empty( $font_color ) ){
                $out .= "
                    ...
                    $widget_id .posts-block-2-items .post .post-title a:hover,
                    $widget_id .posts-block-2-items .post:first-child a.post-meta:hover {
                        color: $font_color;
                    }
            ...
            if( !empty( $bg_color ) ) {
                $out .= "
                    ...
                    $widget_id .posts-block-2-items .post .post-title{
                        color: white;
                    }

                    $widget_id .posts-block-2-items .post:first-child .post-metas,
                    $widget_id .posts-block-2-items .post .post-date{
                        color: #ccc;
                    }

                    $widget_id .posts-block-2-items .post:first-child .post-excerpt{
                        color: #666666;
                    }
