...
add_action('widgets_init', 'jannah_post_block_4');
function jannah_post_block_4() {
    register_widget('jannah_post_block_4');
}

class jannah_post_block_4 extends WP_Widget{

    public function __construct(){
        parent::__construct('jannah_post_block_4',esc_html__('Jannah Post Block 4','jannah-lite'),array(
            'description' => __('Post block style 4','jannah-lite'),
        ));
    ...
    public function widget($arg,$instance){
        ...
        $before_posts  = '<div class="posts-block-4-items widget-posts-wrapper">';
        $after_posts   = '</div>';
                        ...
                        <?php if($featured_1_done == false){ ?>
                            ...
                            <div class="thumb-overlay">
                                ...
                                <div class="post-content">
                                    ...
                                    <p class="post-excerpt"><?php print jannah_excerpt(24); ?></p> 
        ...
        if ( ! empty( $bg_color ) || ! empty( $font_color ) ){
            ...
            if ( ! empty( $font_color ) ){
                $out .= "
                    ...
                    $widget_id .posts-block-4-items .post .post-title a:hover,
                    $widget_id .posts-block-4-items .post:first-child a.post-meta:hover {
                        color: $font_color;
                    }
            ...
            if( !empty( $bg_color ) ) {
                $out .= "
                    ...
                    $widget_id .posts-block-4-items .post .post-date,
                    $widget_id .posts-block-4-items .post .post-title{
                        color: white;
                    }
                ";
            }
